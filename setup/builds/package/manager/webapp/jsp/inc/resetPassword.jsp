<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div id="dialog_password" title='<spring:message code="admin.editUser.dialog.resetTitle"/>' style="display: none">
	<table>
     ...
     <a href="#" id="button-save-dialog" class="ui-button save_button_bg"><span class="save_button"></span><strong><spring:message code="admin.editUser.dialog.reset"/></strong></a>
...
$("#button-save-dialog").click(function() {
    ...
    $.ajax({
   		...
   		data: {"id" : $("input#id").val(), "password" : password},
   		dataType: 'html',
