        	...
        	<form:form id="saveForm" action="saveUser.do" method="post" commandName="newUser" class="form-horizontal">
		        <fieldset>
		          <div class="control-group">
		            ...
		            <div class="controls">
		            	<form:input path="name" id="name" maxlength="20" cssClass="focused"/>
		          ...
		          <div class="control-group">
		            ...
		            <div class="controls">
		            	<form:input path="email" id="email" cssClass=""/>
		          ...
		          <div class="control-group">
		            ...
		            <div class="controls">
		            	<form:textarea path="description" id="description" rows="3"  maxlength="250" cssClass=""/>
		            </div>
		          </div>   		           		                 
		          <div class="control-group">
		            <label class="control-label" for="password"><i class="icon-star"></i>Password</label>
		            <div class="controls">
		            	<form:input path="password" id="password" cssClass=""/>
		          ...
		          <div class="control-group">
		            ...
		            <div class="controls">
		            	<form:input path="confirmPassword" id="confirmPassword" cssClass=""/>
